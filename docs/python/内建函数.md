...
| -|   -  |  内建函数 |-|-|
| :-------- | :-------| :------ | :------ | :------ |
|[abs()](#absx)	|[delattr()](#delattrobject-name)|	[hash()](#hashobject)	|memoryview()| [set()](#class-setiterable) |  
|[all()](#alliterable)	|[dict()](#dict)|	[help()](#helpobject)	| [min()](#min)|	[setattr()](#etattrobject-name-value)
|[any()](#anyiterable)	|[dir()](#dirobject)|	[hex()](#hexx)|	[next()](#nextiterator-default)	|[slice()](#slice)|
|[ascii()](#asciiobject)|	[divmod()](#divmoda-b)|	[id()](#idobject) |	[object()](#class-object)|	[sorted()](#sorted)
|[bin()](#binx)	|[enumerate()](#enumerate-iterable-start0)|	[input()](#inputprompt)	|[oct()](#octx)	|[staticmethod()](#staticmethod)
|[bool()](#class-boolx)	|eval()	| [int()](#int) |	[open()](#open)	|[str()](#str)
|breakpoint()|	exec()|	[isinstance()](#isinstanceobject-classinfo)	|[ord()](#ordc)|	[sum()](#sumiterable-start)
|[bytearray()](#class-bytearraysource-encoding-errors)|	[filter()](#filterfunction-iterable)|	[issubclass()](#issubclassclass-classinfo)|	[pow()](#powx-y-z)|	[super()](#supertype-object-or-type)|
|[bytes()](#class-bytessource-encoding-errors)|	[float()](#class-floatx)|	[iter()](#iterobject-sentinel)	|[print()](#print)|	[tuple()](#tupleiterable)|
|[callable()](#callableobject)|	[format()](#formatvalue-format_spec)|	[len()](#lens)	|[property()](#property)|	[type()](#type)
|[chr()](#chri)|	[frozenset()](#class-frozensetiterable)	| [list()](#class-listiterable)|	[range()](#range)|	[vars()](#varsobject)|
|[classmethod()](#classmethod)	|[getattr()](#getattrobject-name-default)|	[locals()](#locals) |	[repr()](#reprobject)	|[zip()](#zipiterables)|
|compile()|	[globals()](globals)|	[map()](#mapfunction-iterable-)	|[reversed()](#reversedseq)|	[`__import__()`](#import)|
|[complex()](#class-complexreal-imag)|	[hasattr()](#hasattrobject-name)|	[max()](#max)	|[round()](#roundnumber-ndigits)|
